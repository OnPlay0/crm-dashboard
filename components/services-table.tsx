...
export function ServicesTable({ servicios, onEdit, onDelete, onCreateNew }: ServicesTableProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={onCreateNew}><Plus className="mr-2 h-4 w-4" /> Nuevo Servicio</Button>
      </div>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => onDelete(s.id)}>Eliminar</DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </TableCell>
                </TableRow>
